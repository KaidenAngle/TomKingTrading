...
class TradeExecutionLogger:
    ...
    def __init__(self, algorithm):
        ...
        self.algo.Log("📝 ENHANCED TRADE LOGGER INITIALIZED")
    ...
    def get_stage_icon(self, stage_name: str, passed: bool) -> str:
        ...
        return f"{base_icon}✅" if passed else f"{base_icon}❌"
    ...
    def log_execution_summary(self, trade_id: str):
        ...
        summary = f"""
╔══════════════════════════════════════════════════════════════╗
║ TRADE EXECUTION: {trade['strategy']} - {trade['symbol']}
╠══════════════════════════════════════════════════════════════╣
"""
        ...
        for stage in stages:
            ...
            summary += f"║ {status} {stage['stage']:20} {stage['notes'][:30]}\n"
        
        summary += f"""╠══════════════════════════════════════════════════════════════╣
║ Entry Price: ${trade['entry_price']:.2f}
║ Position Type: {trade['position_type']}
║ Max Profit: ${trade['max_profit']:.2f} | Max Loss: ${trade['max_loss']:.2f}
╚══════════════════════════════════════════════════════════════╝
"""
