...
class PerformanceTracker:
    ...
    def UpdateDaily(self):
        ...
        if len(self.daily_pnl) > 0:
            ...
            # Safe division for daily percentage
            if last_value != 0:
    ...
    def UpdateMonthly(self):
        ...
        if month_str not in self.monthly_returns:
            ...
            self.monthly_returns[month_str] = {
                ...
                'return_pct': ((current_value - month_start) / month_start) * 100 if month_start > 0 else 0,
                'trades': 0,
                'wins': 0,
                'losses': 0
            }
    ...
    def GetPerformanceMetrics(self) -> dict:
        ...
        if len(self.daily_pnl) > 1:
            ...
            # Safe division for average daily return
            ...
            denominator = daily_std * (252 ** 0.5)
            if denominator > 0:
                sharpe_ratio = (avg_daily_return * 252) / denominator
            else:
                sharpe_ratio = 0
        else:
            sharpe_ratio = 0
