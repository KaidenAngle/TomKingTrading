...
# USAGE:
# In strategies, replace:
#   self.algo.MarketOrder(contract, quantity)
# With:
#   self.order_helper.place_option_limit_order(contract, quantity)
#
# For iron condors:
#   self.order_helper.place_iron_condor_orders(
